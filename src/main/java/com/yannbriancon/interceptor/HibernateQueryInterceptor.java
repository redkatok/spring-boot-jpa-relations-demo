...
public class HibernateQueryInterceptor extends EmptyInterceptor {
    ...
    private final com.yannbriancon.config.NPlusOneQueriesDetectionProperties NPlusOneQueriesDetectionProperties;

    private static final String HIBERNATE_PROXY_PREFIX = "org.hibernate.proxy";
    private static final String PROXY_METHOD_PREFIX = "jdk.proxy2";

    public HibernateQueryInterceptor(
            com.yannbriancon.config.NPlusOneQueriesDetectionProperties NPlusOneQueriesDetectionProperties
    ) {
